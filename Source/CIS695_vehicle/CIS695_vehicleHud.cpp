...
ACIS695_vehicleHud::ACIS695_vehicleHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ACIS695_vehicleHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if( bHMDDeviceActive == false )
	{
		...
		ACIS695_vehiclePawn* Vehicle = Cast<ACIS695_vehiclePawn>(GetOwningPawn());
		if ((Vehicle != nullptr) && (Vehicle->bInvehicleCameraActive == false))
		{
